...
from transformers import HubertModel #Data2VecAudioModel,
...
"""class data2vec(nn.Module):            
    def __init__(self):        
        super().__init__() 
        self.data2vec_model = Data2VecAudioModel.from_pretrained("/root/qxy/MMML/models/facebook/data2vec-audio-base")
        self.classifier = nn.Linear(768, 1)   """
   
    def forward(self, input_ids, attention_mask):        
        raw_output = self.hubert_model(input_ids, return_dict=True)
