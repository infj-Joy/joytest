...
class AudioDataset(torch.utils.data.Dataset):    
    def __init__(self, dataset, mode, feature):
        ...
        if feature == 'smile': 
            ...
            self.feature_extractor = Wav2Vec2FeatureExtractor("/root/qxy/MMML/models/TencentGameMate/chinese-hubert-base",local_files_only=True,feature_size=1, sampling_rate=16000, padding_value=0.0, do_normalize=True, return_attention_mask=True)
...
def collate_fn_raw(batch):
    ...
    # dynamic padding
    feature_extractor = Wav2Vec2FeatureExtractor("/root/qxy/MMML/models/TencentGameMate/chinese-hubert-base",local_files_only=True,feature_size=1, sampling_rate=16000, padding_value=0.0, do_normalize=True, return_attention_mask=True)
