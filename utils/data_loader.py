...
import transformers
import torchaudio
from transformers import AutoTokenizer, Wav2Vec2FeatureExtractor,HubertModel,AutoFeatureExtractor
...
class Dataset_sims(torch.utils.data.Dataset):
    ...
    def __init__(self, csv_path, audio_directory, mode):       
        ...
        # store texts
        self.texts = df['text']
        self.tokenizer = AutoTokenizer.from_pretrained("/root/qxy/MMML/models/roberta-base",local_files_only=True)
        ...
        self.feature_extractor = AutoFeatureExtractor("/root/qxy/MMML/models/TencentGameMate/chinese-hubert-base",local_files_only=True,feature_size=1, sampling_rate=16000, padding_value=0.0, do_normalize=True, return_attention_mask=True)
